    ...
    Target Pack => _ => _
        ...
        .Executes(() =>
        {
            ...
            DotNetPack(s => s
                ...
                .SetPackageProjectUrl("https://github.com/MrHant/tiver-fowl")
                .SetDescription("A framework for writing Automated Integration tests (including tests via Selenium).")
